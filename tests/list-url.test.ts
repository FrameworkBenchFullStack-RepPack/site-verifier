...
const paramConfigs = [
  ...
  [
    "sort=%63%61teg%6Fry&age-from=39&age-to=%372&category=3&category=%32&size=21&page=2",
    "URL-encoded values",
  ],
  [
    "s%6Frt=category&age-from=39&%61ge-to=72&category=3&category=2&siz%65=21&page=2",
    "URL-encoded keys",
  ],
];
